...
dst_path = 'results/999/run-0_2025-05-14_/Evaluation Tests/'; % e.g., 'C:\results'

% Get list of matching files (outputXXX.png)
files = dir(fullfile(src_path, 'output*.png'));
...
for k = 1:length(files)
    ...
    if ~isempty(token)
        ...
        results = [results; index, piqe_score, niqe_score];
    end
end
